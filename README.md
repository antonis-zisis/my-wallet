...
- **Subscriptions**: Track recurring payments (Netflix, Spotify, etc.) with monthly/yearly billing cycles, cancel or delete subscriptions, and view total monthly cost
